...
(\w{1,16}) was poked to death by a sweet berry bush while trying to escape .+
(\w{1,16}) went off with a bang whilst fighting .+
(\w{1,16}) fell too far and was finished by .+ using .+
(\w{1,16}) drowned while trying to escape .+
(\w{1,16}) was killed by .+ trying to hurt .+
(\w{1,16}) was obliterated by a sonically-charged shriek while trying to escape .+
(\w{1,16}) was skewered by a falling stalactite while fighting .+
(\w{1,16}) fell off a ladder
(\w{1,16}) was impaled by Trident
(\w{1,16}) was pummeled by .+
(\w{1,16}) left the confines of this world
...
(\w{1,16}) starved to death while fighting .+
(\w{1,16}) was stung to death by .+ using .+
(\w{1,16}) experienced kinetic energy
(\w{1,16}) withered away while fighting .+
(\w{1,16}) was squished too much
(\w{1,16}) walked on danger zone due to .+
(\w{1,16}) died from dehydration while trying to escape .+
(\w{1,16}) was killed by even more magic
(\w{1,16}) starved to death whilst fighting .+
(\w{1,16}) suffocated in a wall while fighting .+
(\w{1,16}) discovered the floor was lava
(\w{1,16}) tried to swim in lava to escape .+
(\w{1,16}) was slain by Trident
(\w{1,16}) died
(\w{1,16}) was shot by a skull from .+ using .+
(\w{1,16}) was obliterated by a sonically-charged shriek
...
(\w{1,16}) went off with a bang due to a firework fired from .+ by .+
...
(\w{1,16}) was killed by .+ while trying to hurt .+
(\w{1,16}) was burnt to a crisp whilst fighting .+
(\w{1,16}) was roasted in dragon's breath
...
(\w{1,16}) experienced kinetic energy while trying to escape .+
(\w{1,16}) was slain by .+ using item
(\w{1,16}) was killed while trying to hurt .+
(\w{1,16}) was killed by magic
(\w{1,16}) was doomed to fall by .+
(\w{1,16}) hit the ground too hard while trying to escape .+
(\w{1,16}) fell while climbing
(\w{1,16}) suffocated in a wall whilst fighting .+
(\w{1,16}) was burned to a crisp while fighting .+
...
(\w{1,16}) was squashed by a falling anvil while fighting .+
(\w{1,16}) walked into a cactus while trying to escape .+
(\w{1,16}) was pummeled by .+ using .+
(\w{1,16}) fell off some twisting vines
(\w{1,16}) was killed while fighting .+
...
(\w{1,16}) was struck by lightning while fighting .+
(\w{1,16}) was blown up by .+ using .+
(\w{1,16}) was impaled on a stalagmite while fighting .+
(\w{1,16}) fell from a high place
(\w{1,16}) went off with a bang
(\w{1,16}) walked into the danger zone due to .+
(\w{1,16}) was slain by .+ using .+ and (\w{1,16}) was slain by (\w{1,16}) using .+.
(\w{1,16}) was roasted in dragon's breath by .+
(\w{1,16}) was killed by magic whilst trying to escape .+
(\w{1,16}) walked into fire while fighting .+
(\w{1,16}) was stung to death
(\w{1,16}) was killed trying to hurt .+
(\w{1,16}) was killed by magic while trying to escape .+
(\w{1,16}) was obliterated by a sonically-charged shriek while trying to escape .+ wielding .+
...
(\w{1,16}) went off with a bang while fighting .+
(\w{1,16}) fell out of the world
(\w{1,16}) was squashed by a falling block while fighting .+
(\w{1,16}) was killed
...
(\w{1,16}) was burned to a crisp while fighting .+ wielding .+
